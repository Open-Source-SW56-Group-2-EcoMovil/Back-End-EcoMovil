...
public class VehicleResourceFromEntityAssembler {
    public static VehicleResource toResourceFromEntity(Vehicle entity){
        return new VehicleResource(entity.getId(), entity.getType(), entity.getName(), entity.getYear(), entity.getReview(), entity.getPrice(), entity.getIsAvailable(), entity.getImageUrl(), entity.getLat(), entity.getLng());
    }
}
