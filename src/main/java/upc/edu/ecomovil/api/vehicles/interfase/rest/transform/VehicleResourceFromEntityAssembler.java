...
public class VehicleResourceFromEntityAssembler {
    public static VehicleResource toResourceFromEntity(Vehicle entity){
        return new VehicleResource(entity.getType(), entity.getName(), entity.getYear(), entity.getReview(), entity.getPriceRent(), entity.getPriceSell(), entity.getIsAvailable(), entity.getImageUrl(), entity.getLat(), entity.getLng(), entity.getDescription(),entity.getStudent().getId());
    }
}
